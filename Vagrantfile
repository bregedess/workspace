...
Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "./database", "/home/vagrant/database", id: "work", create: true, mount_options: ["dmode=777,fmode=777"]

  # Provider-specific configuration so you can fine-tune various
  # backing providers for Vagrant. These expose provider-specific options.
  # Example for VirtualBox:
  #
  config.vm.provider "virtualbox" do |vb| #modd
  ...
  # Develop with ruby? uncomment this
  ...
  #you can generate or replace keys with your keys
  config.vm.provision "file", source: "provision/.ssh/id_rsa", destination: "/home/vagrant/.ssh/id_rsa"
  config.vm.provision "file", source: "provision/.ssh/id_rsa.pub", destination: "/home/vagrant/.ssh/id_rsa.pub"
